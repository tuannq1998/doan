                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li><a href="<?php echo e(route('category.product.list')); ?>">List product catalog</a></li>
                        </ul>
                    </li>
                    <li class="sub-menu">
                        <a href="javascript:;">
                        ...
                        <ul class="sub">
                            ...
                            <li><a href="<?php echo e(route('brand.list')); ?>">List brand</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
...
<?php /**PATH C:\xampp\htdocs\CosmeticShop\resources\views/admin_layout.blade.php ENDPATH**/ ?>